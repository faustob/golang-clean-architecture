...
func (c *UserUseCase) Verify(ctx context.Context, request *model.VerifyUserRequest) (*model.Auth, error) {
	...
	telemetry.RecordValidation(ctx, "verify", err)
	if err != nil {
...
func (c *UserUseCase) Create(ctx context.Context, request *model.RegisterUserRequest) (*model.UserResponse, error) {
	...
	err := c.Validate.Struct(request)
	telemetry.RecordValidation(ctx, "register", err)
	if err != nil {
		c.Log.Warnf("Invalid request body : %+v", err)
		return nil, fiber.ErrBadRequest
	}
...
func (c *UserUseCase) Login(ctx context.Context, request *model.LoginUserRequest) (*model.UserResponse, error) {
	...
	err := c.Validate.Struct(request)
	telemetry.RecordValidation(ctx, "login", err)
	if err != nil {
		c.Log.Warnf("Invalid request body  : %+v", err)
		return nil, fiber.ErrBadRequest
	}
...
func (c *UserUseCase) Current(ctx context.Context, request *model.GetUserRequest) (*model.UserResponse, error) {
	...
	err := c.Validate.Struct(request)
	telemetry.RecordValidation(ctx, "current", err)
	if err != nil {
		c.Log.Warnf("Invalid request body : %+v", err)
		return nil, fiber.ErrBadRequest
	}
...
func (c *UserUseCase) Logout(ctx context.Context, request *model.LogoutUserRequest) (bool, error) {
	...
	err := c.Validate.Struct(request)
	telemetry.RecordValidation(ctx, "logout", err)
	if err != nil {
		c.Log.Warnf("Invalid request body : %+v", err)
...
func (c *UserUseCase) Update(ctx context.Context, request *model.UpdateUserRequest) (*model.UserResponse, error) {
	...
	err := c.Validate.Struct(request)
	telemetry.RecordValidation(ctx, "update", err)
	if err != nil {
		c.Log.Warnf("Invalid request body : %+v", err)
		return nil, fiber.ErrBadRequest
	}
